...
public class CombinationLock {
    ...
    public CombinationLock(int combination) {
        if(isCombinationValid(combination))
            ...
            // ili rabotime so isklucok ili stavame defaultna vrednost za combination
    ...
    public static void main(String[] args) {
        ...
        System.out.println(validLock.changeCombination(234, 666));
        ...
        System.out.println(invalidLock.open(235));
