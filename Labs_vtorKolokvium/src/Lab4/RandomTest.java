...
class RandomGenerator {
    ...
    public static int randomBetween(int a, int b) {
        return random.ints(a, b).boxed().distinct().findFirst().get();
    }
    ...
    public static List<Integer> listOfRandomBetween(int a, int b, int length) {
        return random.ints(a, b).limit(length).boxed().collect(Collectors.toList());
    }
    ...
    public static List<Long> listOfRandomBetween(long a, long b, int length) {
       return random.longs( a, b).limit(length).boxed().collect(Collectors.toList());
    }
}
