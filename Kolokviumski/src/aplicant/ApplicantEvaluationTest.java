...
class EvaluatorBuilder {
    public static Evaluator build(Evaluator.TYPE type) throws InvalidEvaluation {
        ...
        return applicant -> {
            switch (type){
                case NO_CRIMINAL_RECORD :return applicant.hasCriminalRecord();
                case MORE_EXPERIENCE : return applicant.getEmploymentYears() >=10;
                case MORE_CREDIT_SCORE : return applicant.getCreditScore() >=500;
                case NO_CRIMINAL_RECORD_AND_MORE_EXPERIENCE : return !applicant.hasCriminalRecord() && applicant.getEmploymentYears() >=10;
                case MORE_EXPERIENCE_AND_MORE_CREDIT_SCORE : return applicant.getEmploymentYears() >=10 && applicant.getCreditScore() >=500;
                case NO_CRIMINAL_RECORD_AND_MORE_CREDIT_SCORE :return !applicant.hasCriminalRecord() && applicant.getCreditScore() >=500;
                default :
                    return false;
